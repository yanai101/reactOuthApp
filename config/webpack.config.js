...
// hot mudule replacement not working with ExtractTextPlugin ... 
// and need disable the ExtractTextPlugin in the plugin sections
const hotModuleReplace = false;
...
module.exports = env => {
  ...
  const cssDev = cssModuls && !hotModuleReplace
